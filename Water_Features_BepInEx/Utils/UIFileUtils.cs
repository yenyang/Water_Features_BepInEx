    ...
    internal static class UIFileUtils
    {
        ...
        internal static void ReadUIFiles(View uiView, string directoryName)
        {
            try
            {
                ...
                {
                    WaterFeaturesMod.Instance.Log.Error(new Exception("unable to locate UI file directory "), directoryPath);
                    return;
                }
            ...
            {
                WaterFeaturesMod.Instance.Log.Error(e, "exception reading UI files");
            }
        }
        ...
        internal static string ReadJS(string fileName)
        {
            ...
            {
                WaterFeaturesMod.Instance.Log.Error(e, $" exception reading JS file {fileName}");
            }
        ...
        private static string ReadCSS(string fileName)
        {
            ...
            {
                WaterFeaturesMod.Instance.Log.Error(e, $" exception reading CSS file {fileName}");
            }
        ...
        private static string ReadUIFile(string fileName)
        {
            ...
            {
                WaterFeaturesMod.Instance.Log.Error(e, $" exception reading UI file {fileName}");
            }
