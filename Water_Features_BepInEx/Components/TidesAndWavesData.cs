// <copyright file="TidesAndWavesData.cs" company="Yenyang's Mods. MIT License">
...
namespace Water_Features.Components
{
    ...
    /// <summary>
    /// A custom component for variable sea water sources.
    /// </summary>
    public struct TidesAndWavesData : IComponentData, IQueryTypeParameter, ISerializable { 
        /// <summary>
        /// The original amount for the sea water source.
        /// </summary>
