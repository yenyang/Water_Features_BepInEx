    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionTabLocaleID(WaterFeaturesSettings.General), "General" },
                { m_Setting.GetOptionTabLocaleID(WaterFeaturesSettings.Experimental), "Experimental" },
                { m_Setting.GetOptionGroupLocaleID(WaterFeaturesSettings.SeasonalStreams), "Seasonal Streams" },
                { m_Setting.GetOptionGroupLocaleID(WaterFeaturesSettings.EvaporationRateGroup), "Evaporation Rate" },
                { m_Setting.GetOptionGroupLocaleID(WaterFeaturesSettings.Reset), "Reset" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(WaterFeaturesSettings.ResetGeneralSettingsButton)), "Reset General Settings" },
                { m_Setting.GetOptionDescLocaleID(nameof(WaterFeaturesSettings.ResetGeneralSettingsButton)), "On confirmation, resets General Settings." },
                { m_Setting.GetOptionWarningLocaleID(nameof(WaterFeaturesSettings.ResetGeneralSettingsButton)), "Reset General Settings?" },
                ...
                { "Assets.DESCRIPTION[WaterSource River]", "These sources have a constant level and must be placed at the border of the map. Typically has medium radius. They will affect the non-playable area beyond the borders." },
