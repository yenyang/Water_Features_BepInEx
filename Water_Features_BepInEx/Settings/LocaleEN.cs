    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public IEnumerable<KeyValuePair<string, string>> ReadEntries(IList<IDictionaryEntryError> errors, Dictionary<string, int> indexCounts)
        {
            return new Dictionary<string, string>
            {
                ...
                { "Assets.DESCRIPTION[WaterSource AutofillingLake]", "Custom modded water source that starts as a Creek, so it fills up quickly until it gets to the desired level and then turns into a Constant Level Water Source (The Vanilla equivilant to a lake). Lakes with a target elevation below the ground level can drain water faster than evaporation." },
